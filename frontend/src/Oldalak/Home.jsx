            ...
            <div className="row">
                ...
                <div className="col-md-4">
                    ...
                    <p>
                        ...
                        <a href="https://www.oktatas.hu/kozneveles/kozepfoku_felveteli_eljaras/kozepfoku_felveteli_eljaras_informacioi" 
                            target="_blank" rel="noopener noreferrer">Tájékoztató oldal</a>
                    </p>
                    <img src="./logo.png" className="img-thumbnail" alt="Logo" title="Logo" />
                </div>
                ...
                <div className="col-md-4">
                    ...
                    <p>
                        ...
                        Mindkét tárgy esetén legfeljebb 50 pont szerezhető. A felvételiző hozott pontjait az általános iskolai év végi eredményei 
                        alapján számolják, ez a pontszám legfeljebb 50 pont lehet. A hozott pontokat duplázzák. A központi felvételin szerzett és 
                        a hozott pontok összege adja a felvételiző összesített pontszámát.
                    </p>
                </div>
